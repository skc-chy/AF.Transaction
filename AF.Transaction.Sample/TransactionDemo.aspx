<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="TransactionDemo.aspx.cs" Inherits="SampleApplication.Web.Transaction.TransactionDemo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width:100%;border-style:inset;border-color:Blue;border-width:thin;">
        <span style="font-size: small">POI : Please check implementation details of Transaction
            in class 'BLFactory.cs' and interface 'ITransactionDemoBL.cs' in project 'AF.Transaction.Business'</span>
    </div>
    <br />
    <br />
    <table>
